...
import JobIcon from '../Images/outline-work_outline-24px.svg'

const PrimaryCard = ({CardType, CardTitle, CardOwnerPhoto, CardOwnerName, CardViews, LocationName, Jobname}) => {
    return(
        <>
            <div className='w-[692px] h-[269px] border-[0.5px] border-[#e0e0e0] rounded-[4px] border-solid flex flex-col'>
                <div>
                ...
                <div className='flex ml-[20px] gap-[40px]'>
                    <div className='flex gap-[4px]'>
                        <img className='w-[20px] h-[20px]' src={JobIcon} alt='...'/>
                        <p className='w-[226px] h-[20px] text-[15px] font-[500]'>{Jobname}</p>
                    </div>
                    <div className='flex gap-[4px]'>
                ...
                <div>
                    <button className='w-[652px] h-[38px] border-[0.35px] border-[#a9aeb8] rounded-[8px] border-solid bg-white text-[#02b875] mx-[20px] text-[13px] font-[600] leading-[18.25px]'>Apply on Timesjobs</button>
                </div>

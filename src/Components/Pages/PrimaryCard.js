...
const PrimaryCard = ({CardImage, CardType, CardTitle, CardPara, CardOwnerPhoto, CardOwnerName, CardViews}) => {
    return(
        <>
            <div className='w-[692px] h-[472px] border-[0.5px] border-[#e0e0e0] rounded-[4px] border-solid flex flex-col'>
                <div>
                ...
                <div className='flex gap-[24px]'>
                    <div>
                        <h3 className='w-[600px] h-[60px] text-[22px] font-[600] leading-[29.52px] ml-[20px]'>{CardTitle}</h3>
                    </div>
                    <div>
                ...
                <div>
                    <p className='w-[652px] h-[25px] text-[#5c5c5c] text-[19px] font-[400] leading-[25.49px] ml-[20px]'>{CardPara}</p>
                </div>
                <div className='flex gap-[292px] mt-[12px]'>
